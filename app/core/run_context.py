...
consumed by anything yet — the tool layer (M2.3), the context budgeter (M4.1), and the loop
(M5.2) will read and write them as those milestones land. Its job today is narrower: give every
...
class RunContext:
    ...
    token_budget: dict | None = None  # ROADMAP M4.1
