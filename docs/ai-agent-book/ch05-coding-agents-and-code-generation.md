...
![Hình 5-2 Quy trình làm việc của Tác nhân mã hóa](images/fig-5-2.png)
...
[^1]: Phân loại sự cố và phân tích cơ chế trong mục này dựa trên nghiên cứu mã nguồn của các Agent cấp sản xuất như Claude Code. Cách triển khai cụ thể tiến hóa rất nhanh theo phiên bản, mục này chỉ chắt lọc những nguyên tắc kỹ thuật ổn định trong đó.
...
![Hình 5-3 So sánh công cụ tìm kiếm Coding Agent](images/fig-5-3.png)
...
![Hình 5-4 So sánh năm giải pháp chỉnh sửa tệp](images/fig-5-4.png)
...
[^2]: Đánh giá đầy đủ về phổ trung thành và bộ quy tắc này, xem Li, Bojie và Noah Shi. *Whose Side Is Your Agent On? Multi-Party* *Principal Loyalty in LLM Agents.* arXiv:2606.30383, 2026.
...
![Hình 5-5 Cơ chế người đề xuất-đánh giá được tạo bởi PPT](images/fig-5-5.png)
...
![Hình 5-6 Quy trình từ đầu đến cuối từ bài báo đến video giải thích](images/fig-5-6.png)
...
![Hình 5-7 Đường dẫn chẩn đoán thông minh nhật ký sản xuất](images/fig-5-7.png)
...
![Hình 5-8 Quá trình tạo biểu mẫu động](images/fig-5-8.png)
...
![Hình 5-9 Quy trình tác nhân truy vấn SQL](images/fig-5-9.png)
...
![Hình 5-10 Vòng lặp khởi động tác nhân](images/fig-5-10.png)
...
![Hình 5-11 Pipeline của Agent có thể tạo ra Agent](images/fig-5-11.png)
