...
| Post-training | post-training | Các bước sau pretraining như SFT/RL để tinh chỉnh hành vi mô |
|  |  | hình. |
| SFT | SFT / supervised fni e-tuning | Fine-tuning có giám sát bằng dữ liệu mẫu. |
